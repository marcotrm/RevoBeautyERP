...
<section class="eroe eroe-foto">
	<picture class="eroe-sfondo deriva">
	...
	<div class="eroe-contenuto">
		...
		<h1 class="eroe-titolo righe">
			<span class="riga"><span>Il centro di estetica</span></span>
...
<section class="sezione intro">
	...
	<h2 class="titolone sale">La pelle ricorda chi se ne prende cura.</h2>
