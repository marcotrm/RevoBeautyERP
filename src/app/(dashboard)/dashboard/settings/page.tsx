...
import {
  ...
  Bell, Globe, CreditCard, Scissors,
...
const settingSections = [
  ...
  { id: 'treatments', label: 'Trattamenti', icon: Scissors, description: 'Listino prezzi e durate' },
...
// =============================================
// =============================================
// TREATMENTS SECTION — CRUD completo
// =============================================
const CATEGORIES = [
    ...
    <div className="space-y-4">
      <div className="bg-bg-secondary border border-border rounded-2xl overflow-hidden">
        <div className="px-6 py-4 border-b border-border flex items-center justify-between gap-3 flex-wrap">
          <h3 className="text-lg font-display font-semibold text-text-primary">Listino Trattamenti <span className="text-sm font-normal text-text-muted">({treatments.length})</span></h3>
          <div className="flex items-center gap-2">
            ...
            <button onClick={openAdd} className="flex items-center gap-1.5 px-3 py-2 rounded-xl gradient-accent text-white text-xs font-medium shadow-lg shadow-accent/20 hover:scale-105 transition-all">
