          ...
          >
            ...
            {activeSection === 'integrations' && (
              ...
              <a href="/dashboard/automazioni" className="flex items-center gap-3 p-4 rounded-2xl bg-accent/5 border border-accent/20 hover:border-accent/40 transition-colors">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-text-primary">Automazioni & Agenti IA</p>
                  <p className="text-xs text-text-muted mt-0.5">Notifiche Telegram sugli incassi, report serali e altri agenti. Spostati nella sezione dedicata.</p>
                </div>
