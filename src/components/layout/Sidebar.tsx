...
import {
  ...
  Warehouse, Sparkles, X, Landmark, Radio, Gift, PartyPopper, CheckSquare, Zap, TrendingUp, Banknote, Receipt, QrCode,
  Smartphone, BookOpen, Inbox, PhoneCall,
} from 'lucide-react';
...
export default function Sidebar() {
  ...
  */
  ...
  /*
    Il numerino di WhatsApp e il suo lampeggio adesso stanno in alto, accanto
    alla chat dell'app: qui WhatsApp era la dodicesima voce su venti, e per
    accorgersi che una cliente aveva scritto bisognava avere l'occhio nel
    posto giusto mentre si guardava l'agenda. Il conteggio vive in
    `TastoWhatsApp`.
  */
