/**
 * La scheda Notifiche: le promo del giorno e i lavori del salone, come un
 * piccolo feed. Le foto parlano da sole — il testo fa da didascalia, non
 * da muro. (Era la "bacheca": stessa sostanza, posto d'onore nella barra.)
 */
...
export default function NotificheScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      >
        <Text style={styles.testata}>Notifiche</Text>
        {data.posts.length === 0 ? (
...
const styles = StyleSheet.create({
  ...
  testata: { ...typography.title, color: colors.primary },
